...
public class CustomImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(viewWidth >= viewHeight)
            viewHeight = (int) Math.ceil(viewWidth * (float) d.getIntrinsicHeight() / d.getIntrinsicWidth());
        else
            viewWidth = (int) Math.ceil(viewHeight * (float) d.getIntrinsicWidth() / d.getIntrinsicHeight());
